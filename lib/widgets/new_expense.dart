...
class _NewExpenseState extends State<NewExpense> {
  ...
  void submitData() {
    ...
    setState(() {
      ...
      ExpensesDatabase.instance.insertExpense(e);
      category = 'Education';
      date = DateTime(2000);
      activeCategory = 0;
    });
      ...
      child: Column(
        ...
        children: [
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: List.generate(expenseCategory.length, (index) {
                return GestureDetector(
                  onTap: () {
                    setState(() {
                      activeCategory = index;
                      category = expenseCategory[index]["name"];
                    });
                  },
                  child: Padding(
